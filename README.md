...
##### - Heroku
[![Deploy with Heroku](https://www.herokucdn.com/deploy/button.svg "Deploy with Heroku")](https://heroku.com/deploy?template=https://github.com/bnsave100/WhatsGram "Deploy with Heroku")<br>
<!--- Deploy to Railway -->
##### - Railway
